...
//     let w = getWidth.apply(this, arguments) || 0,
...
//       place(brick, columns);
//     } else {
//       let groupCount = columnCount + 1 - span,
//         groupY = [],
//         groupColY;
...
//     let minY = Math.min.apply(Math, cols),
//       len = cols.length,
//       shortest = 0;
//     for (var i = 0; i < len; i++) {
//       if (cols[i] === minY) {
...
//     const setHeight = minY + brick.height,
